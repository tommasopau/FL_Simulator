...
def label_flip_attack(
    ...
    """
    Performs a label flip attack.

    This attack flips the labels of the first f clients before training.
    Since the attack occurs prior to gradient computation, the gradients remain unchanged.
